...
class Curp {
    ...
    private function claveFechaNa($dia, $mes, $año) {
        $year = $año[2].$año[3];
        $fecha = $year . $mes . $dia;
        return $fecha;
    }
    ...
    private function claveHomonima($año) {
        if ($año <= 1999) {
            $homo_clave = "0";
        } else {
            $homo_clave = "A";
    ...
    public function generarCURP($nombres, $apellido1, $apellido2, $dia, $mes, $año, $sexo, $edo) {
        $nombre = $this->claveNombre($nombres, $apellido1, $apellido2);
        $fecha = $this->claveFechaNa($dia, $mes, $año);
        $sexoEdo = $this->caveSexoEdo($sexo, $edo);
        $consonantes = $this->claveConsonantesInternas($nombres, $apellido1, $apellido2);
        $homo = $this->claveHomonima($año);
        $curp = $nombre . $fecha . $sexoEdo . $consonantes . $homo;
